...
- Any visitor can also self-register their own **public** account at `/register` with any email/password they choose — the demo public account above is just a convenience, not the only way in.
